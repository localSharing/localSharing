...
//	// Principal principal,
//	// @RequestParam(value = "angebotImage", required = false) MultipartFile
//	// image) {
//	//
//	// Benutzer user = benutzerService.getUserByPrincipal(principal);
//	//
...
//	// }
//
//	// private void saveImageIfExists(MultipartFile image, Ausleihartikel
//	// artikel) {
...
//	// }
//	//
//	// private void saveImageIfExists(MultipartFile image, Tauschartikel
//	// artikel) {
//	// if (isImageValid(image)) {
//	// fileService.save(artikel, image);
//	// }
//	// }
//	//
//	// private void saveImageIfExists(MultipartFile image, Hilfeleistung
//	// artikel) {
//	// if (isImageValid(image)) {
//	// fileService.save(artikel, image);
//	// }
