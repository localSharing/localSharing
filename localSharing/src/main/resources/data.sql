...
--Anfrage
insert into PUBLIC.ANFRAGE (ANFRAGEID, ANGEBOT_ANGEBOTSID, SENDER_USERID, DATUM, STARTDATUM, ENDDATUM, KOMMENTAR, ANFRAGESTATUS, KONTAKT, ANNAHMEKOMMENTAR, ANNAHMEDATUM) values ('1', '1', '1', '2015-05-25', '2015-05-27', '2015-05-30', 'Hätte ich jez mal gerne', 'offen', 'email', null, null);
insert into PUBLIC.ANFRAGE (ANFRAGEID, ANGEBOT_ANGEBOTSID, SENDER_USERID, DATUM, STARTDATUM, ENDDATUM, KOMMENTAR, ANFRAGESTATUS, KONTAKT, ANNAHMEKOMMENTAR, ANNAHMEDATUM) values ('2', '2', '2', '2015-05-25', '2015-05-27', '2015-05-30', 'Gib her', 'angenommen', 'telefon', 'Ja gerne', '2015-05-28');
