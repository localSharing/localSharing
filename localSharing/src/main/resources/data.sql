...
insert into PUBLIC.AUSLEIHARTIKEL (ANGEBOTSID, BESCHREIBUNG, STARTDATUM, TITEL, BENUTZER_USERID, DAUER, ENDDATUM, KATEGORIE) values ('3', 'OLAF :DD', '2014-12-01', 'Frozen', '5', '8', '2016-01-01', 'DVD');
...
insert into PUBLIC.AUSLEIHARTIKEL (ANGEBOTSID, BESCHREIBUNG, STARTDATUM, TITEL, BENUTZER_USERID, DAUER, ENDDATUM, KATEGORIE) values ('9', 'DVDs sind in super Zustand. Tolle Serie, die ich gerne mit euch teile :)', '2014-12-04', 'Das Traumschiff DVD-Box 4', '4', '10', '2015-07-31', 'DVD');
insert into PUBLIC.AUSLEIHARTIKEL (ANGEBOTSID, BESCHREIBUNG, STARTDATUM, TITEL, BENUTZER_USERID, DAUER, ENDDATUM, KATEGORIE) values ('10', 'Ein toller Film. DVD ist in gutem Zustand.', '2014-11-30', '96 Hours', '3', '5', '2015-11-30', 'DVD');
insert into PUBLIC.AUSLEIHARTIKEL (ANGEBOTSID, BESCHREIBUNG, STARTDATUM, TITEL, BENUTZER_USERID, DAUER, ENDDATUM, KATEGORIE) values ('11', 'Ein toller Film. DVD ist in gutem Zustand.', '2014-11-30', 'Die Insel', '3', '5', '2015-11-30', 'DVD');


--Hilfelesitungen
insert into PUBLIC.HILFELEISTUNG (ANGEBOTSID, BESCHREIBUNG, STARTDATUM, TITEL, BENUTZER_USERID, ENDDATUM) values ('1', 'Ich bin gerne behilflich, wenn Streicharbeiten anfallen (und ich ein Stück Kuchen bekomme).', '2014-12-02', 'Streichen', '3', '2015-12-02');
