...
insert into PUBLIC.AUSLEIHARTIKEL (ANGEBOTSID, ENABLED, BESCHREIBUNG, STARTDATUM, TITEL, BENUTZER_USERID, DAUER, ENDDATUM, KATEGORIE) values ('2', 'TRUE', 'Mein Lieblingsfilm. Schaut ihn euch an!', '2014-11-30', 'Titanic', '6', '5', '2016-11-30', 'DVD');
...
insert into PUBLIC.AUSLEIHARTIKEL (ANGEBOTSID, ENABLED, BESCHREIBUNG, STARTDATUM, TITEL, BENUTZER_USERID, DAUER, ENDDATUM, KATEGORIE) values ('6', 'TRUE', 'Schönes Buch, in gutem Zustand.', '2014-12-01', 'The Fault in Our Stars', '7', '14', '2015-03-31', 'Buch');
...
insert into PUBLIC.BEWERTUNG (BEWERTUNGSID, ANGEBOT_ANGEBOTSID, BENUTZER_USERID, BEWERTUNGSTERNE, KOMMENTAR, DATUM) values ('2', '2', '1', '1', 'Gar nicht gut', '2015-05-15');
...
insert into PUBLIC.ANFRAGE (ANFRAGEID, ANGEBOT_ANGEBOTSID, SENDER_USERID, DATUM, STARTDATUM, ENDDATUM, KOMMENTAR, ANFRAGESTATUS, KONTAKT, ANNAHMEKOMMENTAR, ANNAHMEDATUM) values ('3', '1', '7', '2015-05-28', '2015-06-07', '2015-06-10', 'Büüüüüdeeeee', 'angenommen', 'telefon', 'Klar, das passt :)', '2015-05-29');
...
insert into PUBLIC.ANFRAGE (ANFRAGEID, ANGEBOT_ANGEBOTSID, SENDER_USERID, DATUM, STARTDATUM, ENDDATUM, KOMMENTAR, ANFRAGESTATUS, KONTAKT, ANNAHMEKOMMENTAR, ANNAHMEDATUM) values ('6', '11', '2', '2015-05-25', '2015-05-27', '2015-05-30', 'Gib her', 'angenommen', 'telefon', 'Ja gerne', '2015-05-28');
insert into PUBLIC.ANFRAGE (ANFRAGEID, ANGEBOT_ANGEBOTSID, SENDER_USERID, DATUM, STARTDATUM, ENDDATUM, KOMMENTAR, ANFRAGESTATUS, KONTAKT, ANNAHMEKOMMENTAR, ANNAHMEDATUM) values ('7', '10', '4', '2015-05-25', '2015-05-27', '2015-05-30', 'Kann ich das bitte haben?', 'angenommen', 'telefon', 'Klaro', '2015-05-28');
