...
import pandha.swe.localsharing.controller.angebot.sites.get.GET_ZeigeAlleAktiviertenAngebote;

public class TestGet_ZeigeAlleAktiviertenAngebote extends TestAngebote {

	@Before
	public void setUp() throws Exception {
		initTestsAngebote(new GET_ZeigeAlleAktiviertenAngebote());
