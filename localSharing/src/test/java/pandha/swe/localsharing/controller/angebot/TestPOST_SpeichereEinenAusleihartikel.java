...
import pandha.swe.localsharing.controller.angebot.sites.post.POST_SpeichereEinenAusleihartikel;

public class TestPOST_SpeichereEinenAusleihartikel extends TestAngebote {
	@Before
	public void setUp() throws Exception {
		initTestsAngebote(new POST_SpeichereEinenAusleihartikel());
	...
	public void testNeueHilfeleistung() throws Exception {
		...
		String url = "/angebotEdit/333/ausleihen";
