...
import pandha.swe.localsharing.controller.angebot.sites.post.POST_SpeichereEinenNeuenAusleihartikel;

public class TestPOST_NeueAusleihartikel extends TestAngebote {

	@Before
	public void setUp() throws Exception {
		initTestsAngebote(new POST_SpeichereEinenNeuenAusleihartikel());

		resetAndInitAllServices();
	}

	@Test
	public void testNeueAusleihartikel() throws Exception {
